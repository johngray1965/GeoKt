...
abstract class BaseRect :
    IntRectValues,
    RectInterface<Int, KtImmutableRect, IntRectValues> {
...
data class KtImmutableRect(
    override val left: Int,
    override val top: Int,
    override val right: Int,
    override val bottom: Int,
) : BaseRect(),
    ImmutableRectInterface<Int, KtImmutableRect, IntRectValues> {
    ...
    fun setEmpty(): KtImmutableRect = KtImmutableRect()
    ...
    override fun intersect(other: IntRectValues): KtImmutableRect {
    ...
    override fun union(other: IntRectValues): KtImmutableRect =
        when {
            other.isEmpty -> {
                this
            }
            ...
            this.isEmpty -> {
                other as? KtImmutableRect ?: KtImmutableRect(other.left, other.top, other.right, other.bottom)
            }
    ...
    override fun union(
        ...
        when {
            this.isEmpty -> {
                KtImmutableRect(left, top, right, bottom)
            }
    ...
    override fun sort(): KtImmutableRect =
        KtImmutableRect(
            left = min(left, right),
            top = min(top, bottom),
    ...
    fun toMutable() = KtRect(left, top, right, bottom)

    fun toIntArray(): IntArray = intArrayOf(left, top, right, bottom)

    companion object {
        val EMPTY = KtImmutableRect(0, 0, 0, 0)
    }
}
...
data class KtRect(
    ...
    MutableRectInterface<Int, KtImmutableRect, IntRectValues> {
    constructor() : this(0, 0, 0, 0)
    constructor(rectF: FloatRectValues) : this(rectF.left.toInt(), rectF.top.toInt(), rectF.right.toInt(), rectF.bottom.toInt())
    constructor(rect: IntRectValues) : this(rect.left, rect.top, rect.right, rect.bottom)
    ...
    fun toImmutable() = KtImmutableRect(left, top, right, bottom)
