...
class KtMatrixPrePostTest {
    ...
    private fun preRotateWIthOffset(angle: Double) {
        val start = KtMatrix().setTranslate(50.0, 50.0).setScale(0.5, 0.5, 25.0, 25.0)
    ...
    private fun preRotate(angle: Double) {
        val start = KtMatrix().setTranslate(50.0, 50.0).setScale(0.5, 0.5)
    ...
    @Test
    fun preScale() {
        val start = KtMatrix().setTranslate(50.0, 50.0).setRotate(90.0)
    ...
    fun preScaleWithOffset() {
        val start = KtMatrix().setTranslate(50.0, 50.0).setRotate(90.0, 25.0, 25.0)
    ...
    @Test
    fun preTranslate() {
        val start = KtMatrix().setRotate(90.0).setScale(0.5, 0.5)
